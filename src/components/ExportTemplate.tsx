          ...
          <div style={{
            ...
            <div style={{ marginTop: 8, fontSize: 10, color: "#888", display: "flex", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
              ...
              {plans.some(p => p.doubleDropStart && p.doubleDropEnd) && (
                <span style={{ display: "inline-flex", alignItems: "center", gap: 3 }}>
                  <svg width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: 18, height: 12, flexShrink: 0, display: "block" }}>
                    <path d="M15 0C16.6569 0 18 1.34315 18 3V9C18 10.6569 16.6569 12 15 12H3C1.34315 12 0 10.6569 0 9V3C0 1.34315 1.34315 0 3 0H15ZM3.38281 4L5.29688 6.7002L3.37305 9H4.45215L5.79004 7.39844L6.92773 9H8.62695L6.70801 6.2998L8.63184 4H7.55273L6.21484 5.60156L5.07715 4H3.38281ZM12.6143 3.35059C12.3669 3.35059 12.1292 3.39779 11.9014 3.49219C11.6735 3.58333 11.4717 3.71029 11.2959 3.87305C11.1201 4.03581 10.9753 4.22624 10.8613 4.44434C10.7507 4.66243 10.6855 4.89518 10.666 5.14258H11.2666C11.2926 5.01237 11.3398 4.8903 11.4082 4.77637C11.4766 4.65918 11.5596 4.55664 11.6572 4.46875C11.7549 4.38086 11.8623 4.3125 11.9795 4.26367C12.0967 4.21159 12.2171 4.18555 12.3408 4.18555C12.4906 4.18555 12.6224 4.21647 12.7363 4.27832C12.8503 4.34017 12.9463 4.42318 13.0244 4.52734C13.1025 4.63151 13.1611 4.75195 13.2002 4.88867C13.2393 5.02214 13.2588 5.16211 13.2588 5.30859C13.2588 5.41602 13.2458 5.52344 13.2197 5.63086C13.1969 5.73503 13.1514 5.85221 13.083 5.98242C13.0146 6.10938 12.917 6.25423 12.79 6.41699C12.6663 6.5765 12.5036 6.76693 12.3018 6.98828C12.0999 7.20638 11.8542 7.45866 11.5645 7.74512C11.2747 8.03158 10.9297 8.36198 10.5293 8.73633V9H14.3184L14.8164 8.18457H12.0723C12.4954 7.78418 12.86 7.42611 13.166 7.11035C13.4753 6.7946 13.7292 6.50814 13.9277 6.25098C14.1263 5.99056 14.2728 5.75293 14.3672 5.53809C14.4616 5.31999 14.5088 5.11165 14.5088 4.91309C14.5088 4.70475 14.4681 4.50618 14.3867 4.31738C14.3086 4.12858 14.1898 3.96257 14.0303 3.81934C13.8708 3.67611 13.6722 3.56217 13.4346 3.47754C13.2002 3.3929 12.9268 3.35059 12.6143 3.35059Z" fill={C.star}/>
                  </svg>
